 ...
 <body>
  <htmlpageheader name="page-header">
   <div class="row mb-3 print-header">
    <div class="col-md-6" style="width: 80%;float:left;padding-top: 5px">
     <img src="system-images/secondary-logos/{{ session()->get('system-information')->secondary_logo }}" style="height: 1.40in;">
    </div>
    <div class="col-md-6 text-right" style="width: 20%;float:left;padding-top: 25px">
      @if(session()->get('system-information')->show_logo_in_report == 'yes')
         <img src="system-images/logos/{{ session()->get('system-information')->logo }}" style="height: 70px;">
      @endif
    </div>
   </div>
  </htmlpageheader>
