<form action="{{ route('cities.update', $city->id) }}" method="post" id="crud-form" enctype="multipart/form-data">
  @csrf
  @method('PUT')
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="code" id="code" value="{{ $city->code }}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea name="desccription" class="textarea">{{ $city->desccription }}</textarea>
    </div>
    <button type="submit" class="btn btn-primary crud-button"><i class="fa fa-save"></i>&nbsp; Update City</button>
  </form>
